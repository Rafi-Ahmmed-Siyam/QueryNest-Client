...
const Myrecommendations = () => {
   ...
   const { data: recommendations, isLoading, isError } = useQuery({
      ...
      queryFn: async () => {
         ...
         const { data } = await axiosInstance.get(`${import.meta.env.VITE_URL}/recommender-data/${user.email}?recommender=true`);
         return data;
      }
   });
         ...
         <div className='py-5'>
            {
               (recommendations.length === 0) ?
                  <div>
                     <p className="text-center text-base text-gray-500 py-10">
